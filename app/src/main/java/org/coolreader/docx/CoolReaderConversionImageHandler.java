 ...
 *
 */
public class CoolReaderConversionImageHandler extends AbstractConversionImageHandler {
     ...
     * @param includeUUID
     */
    private CoolReaderConversionImageHandler(String imageDirPath, boolean includeUUID) {
     ...
     */
    public CoolReaderConversionImageHandler(String imageDirPath, String targetUri, boolean includeUUID) {
        super(imageDirPath, includeUUID);
